...
// TODO - Add text to app_lang
	...
	echo th_order_by('destination_ext_enabled', $text['label-destination_ext_enabled'], $order_by, $order, '', '', $param);
	...
	if ($result_count > 0) {
		foreach($result as $row) {
			...
			if (permission_exists('destinations_ext_edit')) {
				echo "<a href='destination_ext_edit.php?id=".$row['e911_uuid']."' alt='".$text['button-edit']."'>$v_link_label_edit</a>";
			}
