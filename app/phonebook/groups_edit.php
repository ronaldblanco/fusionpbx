...
//get http post variables and set them to php variables
	if (count($_POST) > 0) {
		...
		$phonegroup_group_name = check_str($_POST["phonegroup_group_name"]);
		$phonegroup_group_desc = check_str($_POST["phonegroup_group_desc"]);
	}
    ...
    if (count($_POST) > 0 && strlen($_POST["persistformvar"]) == 0) {
    	...
    	if (strlen($phonegroup_group_name) == 0) { $msg .= $text['message-required'].$text['label-phonegroup_group_name']."<br>\n"; }
    	...
    	if ($_POST["persistformvar"] != "true") {
            $group_data = array(
                    ...
                    'group_desc' => $phonegroup_group_desc,
                );
