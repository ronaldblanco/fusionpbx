...
if ( session:ready() ) then
    ...
    if trunk ~= 'telgo' or trunk ~= 'astpp4' then
    ...
    if (ani:len() > 5) then -- Seems, we have forwaded call
        fsLog("Call is forwarded. Processing callerid " .. prepend_prefix .. ani)
        ...
        if trunk == 'astpp4' then
            ...
            if local_caller_id then
                ...
                local caller_id_name = "F" .. prepend_prefix .. ani
    ...
    if (#presented_caller_id_number > 0) then
        ...
        if trunk == 'astpp4' then
            ...
            fsLog("Faking CallerID as " .. presented_caller_id_name .. "<" .. presented_caller_id_number .. ">")
